...
const TimerList = lazy(() => import('../../features/timers/TimerList'));
const BridgeInfoPage = lazy(() => import('../../features/hue/BridgeInfo.jsx'));
const HomePage = lazy(() => import('../../pages/home'));
const AddTimerPage = lazy(() => import('../../features/timers/AddTimer.jsx'));
const TimerPage = lazy(() => import('../../features/timers/Timer.jsx'));
